...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  filters: {
    highlight: function highlight(text, term) {
      if (!text) return '';
      text = text.toString();
  ...
  methods: {
    ...
    submitForm: function submitForm() {
      ...
      axios.post('/api/search', {
        ...
        _this.error = errors.response.data.message;
      });
    }
  }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _c("hr"),
    _vm._v(" "),
    typeof _vm.result.Error !== "undefined"
      ? _c("div", [_vm._v(_vm._s(_vm.result.Error))])
      : _vm._e(),
    _vm._v(" "),
    typeof _vm.result.title !== "undefined"
      ? _c("div", [
          _c("h3", [_vm._v("Search result found:")]),
          _vm._v(" "),
          _c("h4", [_vm._v("Title:")]),
          _vm._v(" "),
          _c("p", {
            domProps: {
              innerHTML: _vm._s(
                _vm.$options.filters.highlight(_vm.result.title, _vm.searchTerm)
              )
            }
          }),
          _vm._v(" "),
          ...
          _c("p", {
            domProps: {
              innerHTML: _vm._s(
                _vm.$options.filters.highlight(_vm.result.year, _vm.searchTerm)
              )
            }
          }),
          _vm._v(" "),
          _c("h4", [_vm._v("Runtime: ")]),
          _vm._v(" "),
          _c("p", {
            domProps: {
              innerHTML: _vm._s(
...
__webpack_require__(/*! K:\PhpstormProjects\movie\movie\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! K:\PhpstormProjects\movie\movie\resources\sass\app.scss */"./resources/sass/app.scss");
